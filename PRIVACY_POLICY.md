...
Cloudhood does not collect user data. It stores the following extension data locally in the user's browser:
...
Cloudhood does not sell user data.

Cloudhood does not transfer user data to third parties, except when the user explicitly exports or copies profile data and then shares it outside the extension.

Cloudhood does not use or transfer user data for purposes unrelated to the extension's core functionality, advertising, retargeting, interest-based advertising, creditworthiness, or lending.

## Remote Code

Cloudhood does not execute remote code. Extension code is packaged with the published extension.

## User Control And Deletion

Users can delete stored data by removing profiles inside the extension or by uninstalling the extension from the browser. Users can also clear extension storage through browser settings or developer tools.

## Contact

Cloudhood is developed by Cloud.ru.

Project repository: https://github.com/cloud-ru-tech/cloudhood
